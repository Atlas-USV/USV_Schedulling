            ...
            <ul>
                @forelse ($tasks as $task)
                    <li class="flex justify-between items-center bg-gray-50 p-2 rounded-lg mb-2">
                        ...
                        <div class="flex gap-2">
                            <!-- Edit Button -->
                            <button type="button" onclick="window.location.href='{{ route('tasks.edit', $task->id) }}'"
                            ...
                            <button type="button"
                                ...
                                data-modal-target="deleteTaskModal" data-task-id="{{ $task->id }}"
                                data-modal-toggle="deleteTaskModal">
                                Delete
                            </button>
                        </div>
                    </li>
...
@endsection
                    ...
                    <form action="{{ route('tasks.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <select id="subject" name="subject" required
                                class="form-select rounded-lg w-full border-gray-300 focus:ring-primary-300">
                                <option value="" disabled {{ old('subject') ? '' : 'selected' }}>Select a subject
                                </option>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="datetime-local" id="deadline" name="deadline"
                                ...
                                class="form-input rounded-lg w-full border-gray-300 focus:ring-primary-300">
                        </div>
                        <button type="submit"
        ...
        <div id="deleteTaskModal" tabindex="-1" aria-hidden="true"
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    <div class="p-6 text-center">
                        ...
                        <form id="deleteTaskForm" method="POST">
                            ...
                            @method('DELETE')
                            <button type="submit"
                                class="text-white bg-red-600 hover:bg-red-800 px-5 py-2.5 rounded-lg">Yes, delete
                                it</button>
                            <button type="button" data-modal-hide="deleteTaskModal"
                                class="text-gray-500 bg-white hover:bg-gray-100 px-5 py-2.5 rounded-lg">No, cancel</button>
                        </form>
                    </div>
                </div>
            </div>
