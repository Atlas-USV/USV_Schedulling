...
<body class="bg-gray-50 dark:bg-gray-800">
        ...
        @if (Auth::check())
            ...
            <div class="flex items-center space-x-3 rtl:space-x-reverse">
                    ...
                    <button type="button"
                        ...
                        @else
                            <div
                                class="w-10 h-10 rounded-full bg-gray-200 flex items-center justify-center text-gray-500 text-2xl">
    ...
    <div class=" pt-1  bg-gray-50 dark:bg-gray-900">
                    ...
                    <li>
                        <a href="{{ route('dashboard') }}"
                            ...
                            <svg aria-hidden="true"
                                ...
                                <path
                                    d="M10 2a1 1 0 01.707.293l7 7a1 1 0 01-1.414 1.414L10 4.414 3.707 10.707A1 1 0 012.293 9.293l7-7A1 1 0 0110 2z">
                                </path>
        ...
        <li>
            <a href="{{ route('addinfo.create') }}" class="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
            <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
            <path fill-rule="evenodd" d="M11 4.717c-2.286-.58-4.16-.756-7.045-.71A1.99 1.99 0 0 0 2 6v11c0 1.133.934 2.022 2.044 2.007 2.759-.038 4.5.16 6.956.791V4.717Zm2 15.081c2.456-.631 4.198-.829 6.956-.791A2.013 2.013 0 0 0 22 16.999V6a1.99 1.99 0 0 0-1.955-1.993c-2.885-.046-4.76.13-7.045.71v15.081Z" clip-rule="evenodd"/>
              </svg>
              <span class="flex-1 ml-3 text-left whitespace-nowrap">Consultations</span>
            </a>
        </li>
        @endif
                        </ul>
                    ...
                    @if (Auth::check())
                            ...
                            <ul id="dropdown-sales" class="hidden py-2 space-y-2">
                                <li>
                                    <a href="{{ route('calendar') }}"
                                        class="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Programarea
                                        examenelor</a>
                                </li>
                                <!-- <li>
                      ...
                      <li>
                        ...
                        <li>
                            <button type="button"
                                class="flex items-center p-2 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
                                aria-controls="dropdown-requests-messages"
                                data-collapse-toggle="dropdown-requests-messages">
                                <svg class="w-6 h-6 text-gray-400 dark:text-gray-400" aria-hidden="true"
                                ...
                                @php
                                    ...
                                    $pendingRequests = App\Models\Request::where(function ($query) {
                                        $query->where('teacher_id', Auth::id())->orWhere('student_id', Auth::id());
                                    })
                                ...
                                @if ($totalNotifications > 0)
                                    <span
                                        class="inline-flex justify-center items-center w-5 h-5 text-xs font-semibold rounded-full text-white bg-red-500">
                                        {{ $totalNotifications }}
                                    </span>
                                @endif
                                <svg aria-hidden="true" class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20"
                            ...
                            <ul id="dropdown-requests-messages" class="hidden py-2 space-y-2">
                                <li>
                                    <a href="{{ route('inbox.index') }}"
                                        ...
                                        @if ($unreadMessages > 0)
                                            <span
                                                class="inline-flex justify-center items-center w-5 h-5 text-xs font-semibold rounded-full text-white bg-red-500 ml-auto">
                                                {{ $unreadMessages }}
                                            </span>
                                        @endif
                                    </a>
                                ...
                                <li>
                                    <a href="{{ route('requests.markStatusUpdatesAsRead') }}"
                                        class="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                                        Status Updates
                    ...
                    <li>
                        ...
                        <ul id="dropdown-authentication" class="hidden py-2 space-y-2">
                            @if (Auth::check())
                                ...
                                <li>
                                    <a href="{{ route('home') }}"
                                        class="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Log
                                        Out</a>
                                </li>
                            @endif
                            @if (!Auth::check())
                    ...
                    @if (Auth::check() && (Auth::user()->hasRole('admin') || Auth::user()->hasRole('secretary')))
                        <li>
                            ...
                            <ul id="dropdown-management" class="hidden py-2 space-y-2">
                                <li>
                                    <a href="{{ route('evaluations.pending') }}"
                                        class="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                                        <svg class="w-5 h-5 text-gray-800 dark:text-white mr-3" aria-hidden="true"
                                            xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                            viewBox="0 0 24 24">
                                            <path d="M4 4h16v2H4zM10 9h4v2h-4zM10 13h4v6h-4zM8 9h2v10H8zM14 9h2v10h-2z">
                                            </path>
                                        </svg>
                    ...
                    <li>
                        <div class="overflow-y-auto py-5 px-2 dark:text-gray-100">
                            <label for="theme-toggle" class="flex items-center cursor-pointer">
                                ...
                                <div class="relative">
                                    <div
                                        class="switch-bg w-10 h-6 bg-gray-300 rounded-full shadow-inner transition-colors duration-300 ease-in-out">
                                    </div>
                                    <div
                                        class="dot absolute w-6 h-6 bg-white rounded-full shadow inset-y-0 left-0 transition-transform duration-300 ease-in-out transform">
                                    </div>
                                </div>
                            </label>
                        </div>
            ...
            <style>
                ...
                #theme-toggle:checked+div .dot {
                    ...
                    /* Mută bulina în partea dreaptă */
                }

                /* Stiluri pentru titlul My Account în modul întunecat */
                body.dark .my-account-title {
                    color: #E2E8F0;
                    /* O nuanță deschisă pentru a contrasta cu fundalul întunecat */
                }
            </style>
    ...
    @if (session('success'))
        <div id="toast-success"
            class="fixed bottom-4 right-4 z-50 flex items-center w-full max-w-xs p-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800"
            role="alert">
            <div
