<form class="p-4 md:p-5">
    <div class="grid gap-4 mb-4 grid-cols-2">
        ...
        <!-- Teacher Dropdown -->
        <div class="col-span-2 sm:col-span-1">
            <label for="teacher_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Cadru
                didactic</label>
            <div class="relative">
        ...
        <!-- Replace the existing room dropdown with this simplified version -->
        <div class="col-span-2 sm:col-span-1">
        ...
        <div class="col-span-2 sm:col-span-1">
            <label for="number-input" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Durata
                (min)</label>
            <input type="number" id="number-input" aria-describedby="helper-text-explanation"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                placeholder="120" required />
            <p id='durata-error-message'class="mt-2 text-sm text-red-600 dark:text-red-500 hidden">Durate trebuie sa fie
                cuprinsa intre 10 si 360 min</p>
        </div>

        <div class="col-span-2">
            <label for="description" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Informatii
                aditionale:</label>
...
<script>
    ...
    $(document).ready(function() {
        ...
        const selectGroup = HSSelect.getInstance(`#group_id`);
        const selectTeacher = HSSelect.getInstance(`#teacher_id`);
        const selectRoom = HSSelect.getInstance(`#room_id`);
        const selectSubject = HSSelect.getInstance(`#subject_id`);
        const examinators = window.HSSelect.getInstance('#examinators', true);

        function initialPopulation() {
            window.populateDropdown('group_id', groups, grupaPlaceholder, 'id', {
                'name': '',
                'speciality_short_name': ' •'
            }, selectGroup)
            // window.populateDropdown('teacher_id', cadri, cadriPlaceholder, 'id', {'name':''}, selectTeacher)
        ...
        $('#submitExam').click(function(e) {
            ...
            //const examinators = window.HSSelect.getInstance('examinators');
            ...
            const formData = {
                ...
                other_examinators: examinators.element.value,
