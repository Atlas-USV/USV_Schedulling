...
<div class="col-span-2 sm:col-span-1">
        <label for="colloquium_group_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Grupa</label>
        <select name="colloquium_group_id" id="colloquium_group_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
    ...
    <!-- Subject Dropdown -->
    <div class="col-span-2 sm:col-span-1">
        <label for="colloquium_subject_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Subiect</label>
        <select name="colloquium_subject_id" id="colloquium_subject_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
    ...
    <!-- Teacher Dropdown -->
    <div class="col-span-2 sm:col-span-1">
        <label for="colloquium_teacher_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Cadru didactic</label>
        <select name="colloquium_teacher_id" id="colloquium_teacher_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
    ...
    <!-- Room Dropdown -->
    <div class="col-span-2 sm:col-span-1">
        <label for="colloquium_room_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Sala</label>
        <select name="colloquium_room_id" id="colloquium_room_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
    ...
    <!-- Start Time -->
    <div class="col-span-2 sm:col-span-1">
        <label for="colloquium_start_time" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">De la</label>
        <input type="datetime-local" name="start_time" id="colloquium_start_time" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" required>
    </div>

    <div class="col-span-2 sm:col-span-1">
    <label for="colloquium-number-input" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Durata (min)</label>
...
<script>
    ...
    function initialPopulation(){
        window.populateDropdown('colloquium_group_id', groups, grupaPlaceholder, 'id', {'name': '', 'speciality_short_name': ' •'})
        window.populateDropdown('colloquium_teacher_id', cadri, cadriPlaceholder, 'id', {'name':''})

    }
    $(document).ready(function(){
        initialPopulation()
    })
    $('#submitColloquium').click(function (e) {
        e.preventDefault(); // Prevent form from submitting normally
        var csrfToken = $('meta[name="csrf-token"]').attr('content');

      // Log it to the console

            const numberInput = $('#colloquium-number-input')
            const errorMessage = $('#colloquium-durata-error-message')
         ...
         //   const speciality_id = $('#speciality_id').val();
            ...
            const formData = {
                subject_id: colloquium_subject_id,
                teacher_id: colloquium_teacher_id,
