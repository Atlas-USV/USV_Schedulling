...
<div class="col-span-2 sm:col-span-1">
    ...
    <div class="relative">
        <select id="colloquium_group_id" name="colloquium_group_id"
            data-hs-select='{
            "hasSearch": true,
...
<div class="col-span-2 sm:col-span-1">
    ...
    <div class="relative">
        <select id="colloquium_subject_id" name="colloquium_subject_id"
            data-hs-select='{
            "hasSearch": true,
            "searchPlaceholder": "Caută...",
            "searchClasses": "block w-full text-sm border-gray-200 rounded-lg focus:border-blue-500 focus:ring-blue-500 before:absolute before:inset-0 before:z-[1] dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 py-2 px-3",
...
<div class="col-span-2 sm:col-span-1">
    ...
    <div class="relative">
        <select id="colloquium_teacher_id" name="colloquium_teacher_id"
            data-hs-select='{
            "hasSearch": true,
            "searchPlaceholder": "Caută...",
            "searchClasses": "block w-full text-sm border-gray-200 rounded-lg focus:border-blue-500 focus:ring-blue-500 before:absolute before:inset-0 before:z-[1] dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 py-2 px-3",
...
<div class="col-span-2 sm:col-span-1">
    ...
    <div class="relative">
        <select id="colloquium_room_id" name="colloquium_room_id"
            data-hs-select='{
            "hasSearch": true,
            "searchPlaceholder": "Caută...",
            "searchClasses": "block w-full text-sm border-gray-200 rounded-lg focus:border-blue-500 focus:ring-blue-500 before:absolute before:inset-0 before:z-[1] dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 py-2 px-3",
...
<script>
    ...
    $(document).ready(function(){
        const selectTeacher = window.HSSelect.getInstance(`#colloquium_teacher_id`);
        const selectGroup = window.HSSelect.getInstance(`#colloquium_group_id`);
        const selectRoom = HSSelect.getInstance(`#colloquium_room_id`);
        const selectSubject = HSSelect.getInstance(`#colloquium_subject_id`);
        const examinators = window.HSSelect.getInstance('#colloquium-examinators', true);
        function initialPopulation(){
        window.populateDropdown('colloquium_group_id', groups, grupaPlaceholder, 'id', {'name': '', 'speciality_short_name': ' •'}, selectGroup)
       // window.populateDropdown('colloquium_teacher_id', cadri, cadriPlaceholder, 'id', {'name':''}, selectTeacher)
         ...
         //   const speciality_id = $('#speciality_id').val();
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $('#colloquium_start_time').val('');
                    $('#colloquium-number-input').val('');
                    ...
                    $('#colloquium-durata-error-message').addClass('hidden');
                },
