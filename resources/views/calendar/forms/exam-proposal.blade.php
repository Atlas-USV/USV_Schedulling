...
<div id="exam-proposal-modal" tabindex="-1" aria-hidden="true"
    class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%)]">
    <div class="relative p-4 w-full max-w-3xl">
        <!-- Modal content -->
        <div class="relative bg-white rounded-lg h-auto max-h-[95vh]  shadow dark:bg-gray-700">
                ...
                <div class="grid gap-4 mb-4 md:grid-cols-2 grid-cols-1">
                    ...
                    <div>
                        ...
                        <div class="col-span-2 sm:col-span-1">
                            ...
                            <input type="datetime-local" name="start_time" id="exam-proposal-date-picker"
    ...
    class="justify-self-start self-center text-white inline-flex items-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
...
<script>
    ...
    $('#submit-exam-proposal').click(function(e) {
        ...
        const formData = {
            ...
            end_time: moment(date).add(inputValue, 'minutes').toISOString(),
            type: type
