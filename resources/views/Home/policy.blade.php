...
<main class="max-w-screen-lg mx-auto my-8 px-4">
    <h1 class="text-3xl font-bold mb-4">Privacy Policy</h1>
    <p class="text-base text-gray-700 dark:text-gray-300 mb-4">
        At Exam Planner Pro, your privacy is our priority. This Privacy Policy outlines how we collect, use, and protect your information. By using our website, you agree to the terms of this Privacy Policy.
    </p>
    <h2 class="text-2xl font-semibold mb-2">Information We Collect</h2>
    <p class="text-base text-gray-700 dark:text-gray-300 mb-4">
        We may collect personal information, such as your name, email address, and any details provided during registration or communication with us.
    </p>
    <h2 class="text-2xl font-semibold mb-2">How We Use Your Information</h2>
    <p class="text-base text-gray-700 dark:text-gray-300 mb-4">
        The information we collect is used to enhance your experience, provide support, and improve our services. We do not sell your personal information.
    </p>
    <h2 class="text-2xl font-semibold mb-2">Contact Us</h2>
    <p class="text-base text-gray-700 dark:text-gray-300">
        If you have questions about our Privacy Policy, please <a href="{{ route('contact') }}" class="text-blue-600 hover:underline">contact us</a>.
    </p>
</main>
