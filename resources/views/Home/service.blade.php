...
<main class="max-w-screen-lg mx-auto my-8 px-4 ">
    ...
    <p class="text-base text-gray-700 dark:text-gray-300 mb-4">
        By using Exam Planner Pro, you agree to the following terms and conditions. Please read them carefully before using our services.
    </p>
    <h2 class="text-2xl font-semibold mb-2">Acceptance of Terms</h2>
    <p class="text-base text-gray-700 dark:text-gray-300 mb-4">
        These Terms of Service govern your use of our platform. If you do not agree with any part of these terms, you may not access or use the service.
    </p>
    <h2 class="text-2xl font-semibold mb-2">User Responsibilities</h2>
    <p class="text-base text-gray-700 dark:text-gray-300 mb-4">
        You agree to use the platform responsibly and in accordance with applicable laws. Misuse of the platform may result in termination of access.
    </p>
    <h2 class="text-2xl font-semibold mb-2">Contact Us</h2>
    <p class="text-base text-gray-700 dark:text-gray-300">
        For any inquiries regarding these Terms of Service, please <a href="{{ route('contact') }}" class="text-blue-600 hover:underline">contact us</a>.
    </p>
</main>
